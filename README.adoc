...
----
 mvn archetype:generate -DgroupId=cs.java -DartifactId=lab -DarchetypeArtifactId=maven-archetype-quickstart -DinteractiveMode=false
----
...
----
mvn clean verify
java -cp target/lab-1.0-SNAPSHOT.jar cs.java.Calculator
